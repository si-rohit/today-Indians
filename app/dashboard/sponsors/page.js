  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className='flex justify-between items-center mb-6'>
        <div className="text-3xl font-bold">Sponsors</div>
        ...
        <div>
          <div className={`p-6 min-h-[60vh] flex flex-col  mb-10 ${inputValue ? 'items-center justify-start' : 'items-center justify-center'}`}>
            ...
            selectInvite !== null && <div>
              {LargePartners.find((partner) => partner.name === selectInvite).request === true ? <VerifyRequest type='sponsor' name={selectInvite} handleCloseVerifyModal={handleCloseVerifyModal} /> : <AlreadyConected name={selectInvite} type='sponsor' handleCloseVerifyModal={handleCloseVerifyModal}/>}
            </div> 
          }  
          </div> 
        </div> 
